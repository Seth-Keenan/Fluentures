...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const base =
      "inline-flex items-center justify-center rounded px-4 py-2 text-sm transition duration-200 " +
      "focus:outline-none focus:ring-2 focus:ring-offset-1 disabled:opacity-60 disabled:cursor-not-allowed";

    const variants: Record<NonNullable<ButtonProps["variant"]>, string> = {
      primary: "bg-amber-400 text-white hover:bg-amber-500 focus:ring-amber-300",
      secondary:
