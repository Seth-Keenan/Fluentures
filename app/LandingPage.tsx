    ...
    <div className="relative w-full overflow-x-hidden">
      ...
      <PageBackground src={desert.src} alt={desert.name} wikiUrl={desert.wikiUrl}>
        ...
        <section className="relative z-10 min-h-[calc(100vh-5rem)] flex items-center justify-center px-4 pt-6">
          <motion.div
            className="w-[min(92vw,52rem)] rounded-2xl border border-white/20 bg-white/10 backdrop-blur-xl shadow-2xl p-6 sm:p-10"
          ...
          >
            <motion.div style={{ y: heroY, opacity: heroOpacity }} className="text-center">
              <motion.h1
                className="text-white text-3xl sm:text-5xl font-semibold leading-tight text-balance"
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.1, duration: 0.45 }}
              >
                {/* First part: breaks nicely on mobile, inline on desktop */}
                <span className="block sm:inline">Fluentures makes</span>{" "}
                <span className="block sm:inline">language learning</span>{" "}
                {/* Highlighted part: stacked on mobile, inline on desktop */}
                <span className="block mt-2 sm:inline sm:mt-0 sm:ml-2">
                  <span className="inline-block mx-1 px-2 rounded-lg bg-indigo-500/80">
                    consistent
                  </span>{" "}
                  and{" "}
                  <span className="inline-block mx-1 px-2 rounded-lg bg-amber-400/80">
                    fun
                  </span>
                  !
                </span>
              ...
              <p className="mt-6 text-center text-xs text-white/70">-camelCase-</p>
            </motion.div>
          </motion.div>
        </section>
